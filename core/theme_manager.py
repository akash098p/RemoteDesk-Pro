...
class ThemeManager:
    ...
    def _normalize_theme_data(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        alias("card_title", ["text_primary", "text"])
        alias("card_footer_text", ["text_secondary", "text_primary", "text"])
        alias("error", ["danger"])
        alias("error_hover", ["notification_close_hover", "titlebar_close_hover", "danger", "error"])
        alias("close_button_bg", ["icon_button_bg", "card", "background"])
        alias("close_button_hover_bg", ["titlebar_close_bg", "danger", "error"])
        alias("close_button_text", ["icon_button_text", "text_primary", "text"])
